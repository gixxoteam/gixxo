...
const createFundingAccount = ({
  ...
  return new Promise((resolve, reject) => {
    contract.methods
      .setCharityAccount(fundAddress, target_amount, description, proof)
      .send({
        from: senderAccount,
...
const voteAccount = (fundAddress, voteValue, voteHash, is_activated) => {
  return new Promise((resolve, reject) => {
    ...
    contract.methods
      .voteAccount(fundAddress, voteValue, voteHash, is_activated)
      .send({
        from: senderAccount,
        gas: 1000000, // Gas sent with each transaction
